...
export class MyaccountPage {
  ...
  constructor(public app: App,private conf: Config, public platform: Platform, public http: Http, public navCtrl: NavController, public navParams: NavParams, public nav: NavController) {
