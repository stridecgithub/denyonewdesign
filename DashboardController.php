...
class DashboardController extends Controller {
    ...
    public function index(Request $request, DashboardDataTable $dataTable) {
        ...
        if ($ismobile == 1) {
			...
			$unitids = '';
			$i = $offlinecount = $alarmcount = $warningcount = $runningcount = $markercount = 0;
			...
			return $dataTable->render('Dashboard.index', ['unitids' => $unitids, 'ses_login_id' => $ses_login_id, 'dashboardunits' => $dashboardunits, 'access' => $access, 'location' => $location, 'informations' => $informations, 'icons' => $icons, 'offlinecount' => $offlinecount, 'warningcount' => $warningcount, 'runningcount' => $runningcount, 'alarmcount' => $alarmcount, 'markercount' => $markercount]);			
		}
	}
